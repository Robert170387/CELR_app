...
$categories = $pdo->query("SELECT * FROM expense_categories ORDER BY type DESC, name ASC")->fetchAll();
?>
                        ...
                        <thead class="bg-gray-50">
                            <tr>
                                <th class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">
                                    Nombre</th>
                                <th class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Código (Slug)</th>
                            ...
                            <?php foreach ($categories as $cat): ?>
                                <tr>
                                    ...
                                    <td
                                        ...
                                        <a href="category_details.php?id=<?php echo $cat['id']; ?>"
